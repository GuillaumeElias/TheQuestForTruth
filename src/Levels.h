...
namespace levels
{
    ...
    PROGMEM static const Cell LEVEL_0[] =
    {
        ...
        {0,17}, {51,1}, {0,4}, {9,5}, {0,8}, {9,10}, {0,3}, {0,0xFF},
        {0,21}, {9,6}, {0,4}, {1,1}, {0,3}, {9,11}, {0,1}, {99,0xFF},
        {0,14}, {9,13}, {0,8}, {9,11}, {0,2}, {0,0xFF},
    ...
    PROGMEM static const Cell LEVEL_1[] =
    {
        ...
        {1,20}, {0,4}, {1,2}, {0,12}, {2,2}, {41,1}, {2,3}, {40,1}, {2,1}, {1,2}, {1,0xFF},
        {0,1}, {2,2}, {0,15}, {2,2}, {0,3}, {1,4}, {0,11}, {1,10}, {1,0xFF},
        {0,1}, {2,2}, {0,15}, {2,2}, {0,2}, {1,6}, {0,3}, {5,1}, {6,1}, {0,1}, {5,1}, {6,1}, {0,2}, {1,10}, {1,0xFF},
        {0,1}, {2,2}, {0,15}, {2,2}, {0,2}, {2,2}, {3,1}, {2,3}, {0,3}, {7,1}, {8,1}, {0,1}, {7,1}, {8,1}, {0,1}, {1,11}, {1,0xFF},
        {0,1}, {2,2}, {0,7}, {82,1}, {0,6}, {62,1}, {2,2}, {0,2}, {2,2}, {40,1}, {2,3}, {0,2}, {9,7}, {1,11}, {1,0xFF},
        {0,1}, {2,2}, {0,15}, {2,2}, {0,2}, {2,2}, {40,1}, {2,3}, {0,1}, {9,8}, {1,11}, {1,0xFF}
    };
    PROGMEM static const Cell LEVEL_2[] =
    {
        {0,40}, {4,1}, {0,7}, {0,0xFF},
        {0,40}, {4,1}, {0,7}, {0,0xFF},
        {0,3}, {1,18}, {0,19}, {4,1}, {0,7}, {0,0xFF},
        {0,9}, {1,1}, {0,13}, {4,1}, {0,3}, {4,1}, {0,5}, {4,1}, {0,1}, {4,2}, {0,1}, {4,3}, {0,5}, {52,1}, {0,0xFF},
        {0,8}, {99,1}, {1,1}, {0,31}, {52,1}, {0,5}, {4,0xFF},
        {0,9}, {1,1}, {0,21}, {4,1}, {0,16}, {0,0xFF},
        {0,2}, {4,1}, {0,1}, {4,2}, {0,42}, {0,0xFF},
        {0,29}, {52,1}, {0,4}, {52,1}, {0,10}, {1,1}, {0,2}, {0,0xFF},
        {0,23}, {52,1}, {0,16}, {52,1}, {0,3}, {1,4}, {1,0xFF},
        {0,43}, {2,2}, {3,1}, {2,1}, {1,0xFF},
        {0,43}, {2,2}, {43,1}, {2,1}, {1,0xFF},
        {0,6}, {83,1}, {0,1}, {63,1}, {0,17}, {9,10}, {0,7}, {2,2}, {43,1}, {2,1}, {1,0xFF},
        {0,14}, {71,1}, {0,4}, {9,29}, {9,0xFF}
    };
    PROGMEM static const Cell LEVEL_3[] =
    {
        ...
        {0,19}, {51,2}, {0,9}, {51,1}, {0,17}, {0,0xFF},
        {0,33}, {1,2}, {0,13}, {0,0xFF},
        {1,9}, {0,5}, {1,21}, {0,13}, {0,0xFF},
        {0,48}, {0,0xFF},
        {0,48}, {0,0xFF},
        {0,37}, {1,3}, {0,8}, {0,0xFF},
        {0,48}, {0,0xFF},
        {0,3}, {84,1}, {0,1}, {61,1}, {0,7}, {52,1}, {0,7}, {5,1}, {6,1}, {0,1}, {5,1}, {6,1}, {0,22}, {0,0xFF},
        {0,21}, {7,1}, {8,1}, {0,1}, {7,1}, {8,1}, {0,22}, {0,0xFF},
        {0,1}, {4,47}, {4,0xFF}
    };
    PROGMEM static const Cell LEVEL_4[] =
    {
        ...
        {0,5}, {4,1}, {0,1}, {4,2}, {0,16}, {1,1}, {0,13}, {4,1}, {0,8}, {0,0xFF},
        {0,4}, {4,1}, {0,20}, {1,1}, {0,22}, {0,0xFF},
        {0,25}, {1,1}, {0,8}, {4,1}, {0,13}, {0,0xFF},
        {0,14}, {4,5}, {1,1}, {0,5}, {1,1}, {0,22}, {0,0xFF},
        {0,19}, {1,1}, {0,2}, {52,2}, {0,1}, {1,1}, {0,13}, {4,1}, {0,8}, {0,0xFF},
        {0,9}, {4,1}, {0,2}, {4,2}, {0,5}, {1,1}, {0,2}, {52,2}, {0,1}, {1,1}, {0,22}, {0,0xFF},
        {0,19}, {1,2}, {0,4}, {1,1}, {0,22}, {0,0xFF},
        {0,2}, {4,3}, {0,18}, {52,1}, {0,1}, {1,1}, {0,4}, {5,1}, {6,1}, {0,2}, {85,1}, {0,4}, {63,1}, {0,8}, {0,0xFF},
        {0,25}, {1,1}, {0,4}, {7,1}, {8,1}, {0,16}, {0,0xFF}
    };

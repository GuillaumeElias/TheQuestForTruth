...
namespace levels
{
    ...
    PROGMEM static const Cell LEVEL_2[] =
    {
        {0,40}, {4,1}, {0,6}, {0,0xFF},
        {0,40}, {4,1}, {0,6}, {0,0xFF},
        {0,3}, {1,18}, {0,19}, {4,1}, {0,6}, {0,0xFF},
        {0,9}, {1,1}, {0,13}, {4,1}, {0,3}, {4,1}, {0,5}, {4,1}, {0,1}, {4,2}, {0,1}, {4,3}, {0,5}, {52,1}, {0,0xFF},
        {0,8}, {99,1}, {1,1}, {0,31}, {52,1}, {0,5}, {4,0xFF},
        {0,9}, {1,1}, {0,21}, {4,1}, {0,15}, {0,0xFF},
        {0,2}, {4,1}, {0,1}, {4,2}, {0,41}, {0,0xFF},
        {0,29}, {52,1}, {0,4}, {52,1}, {0,10}, {1,1}, {0,1}, {0,0xFF},
    ...
    PROGMEM static const Cell LEVEL_3[] =
    {
        {0,47}, {0,0xFF},
        {0,47}, {0,0xFF},
        {0,1}, {99,1}, {0,45}, {0,0xFF},
        {0,19}, {51,2}, {0,9}, {51,1}, {0,16}, {0,0xFF},
        {0,33}, {1,2}, {0,12}, {0,0xFF},
        {1,9}, {0,5}, {1,21}, {0,12}, {0,0xFF},
        {0,47}, {0,0xFF},
        {0,47}, {0,0xFF},
        {0,37}, {1,3}, {0,7}, {0,0xFF},
        {0,47}, {0,0xFF},
        {0,3}, {84,1}, {0,1}, {61,1}, {0,7}, {52,1}, {0,7}, {5,1}, {6,1}, {0,1}, {5,1}, {6,1}, {0,21}, {0,0xFF},
        {0,21}, {7,1}, {8,1}, {0,1}, {7,1}, {8,1}, {0,21}, {0,0xFF},
        {0,1}, {4,46}, {4,0xFF}
    };
    PROGMEM static const Cell LEVEL_4[] =
    {
        ...
        {0,4}, {4,1}, {0,20}, {1,1}, {0,21}, {1,0xFF},
        {0,25}, {1,1}, {0,13}, {4,1}, {0,7}, {1,0xFF},
        {0,14}, {4,5}, {1,1}, {0,5}, {1,1}, {0,21}, {1,0xFF},
        {0,19}, {1,1}, {0,2}, {52,2}, {0,1}, {1,1}, {0,21}, {1,0xFF},
        {0,9}, {4,1}, {0,2}, {4,2}, {0,5}, {1,1}, {0,2}, {52,2}, {0,1}, {1,1}, {0,16}, {4,1}, {0,4}, {1,0xFF},

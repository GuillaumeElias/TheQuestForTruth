...
namespace levels
{
    ...
    PROGMEM static const Cell LEVEL_2[] =
    {
        {0,40}, {4,1}, {0,7}, {0,0xFF},
        {0,40}, {4,1}, {0,7}, {0,0xFF},
        {0,3}, {1,18}, {0,18}, {99,1}, {4,1}, {0,7}, {0,0xFF},
        {0,23}, {4,1}, {0,3}, {4,1}, {0,5}, {4,1}, {0,1}, {4,2}, {0,1}, {4,3}, {0,5}, {52,1}, {0,0xFF},
        {0,41}, {52,1}, {0,5}, {4,0xFF},
        {0,31}, {4,1}, {0,16}, {0,0xFF},
        {0,48}, {0,0xFF},
        {0,29}, {52,1}, {0,4}, {52,1}, {0,10}, {1,1}, {0,2}, {0,0xFF},
        {0,23}, {52,1}, {0,16}, {52,1}, {0,3}, {1,4}, {1,0xFF},
        {0,43}, {2,2}, {3,1}, {2,1}, {1,0xFF},
        {0,43}, {2,2}, {41,1}, {2,1}, {1,0xFF},
        {0,6}, {83,1}, {0,1}, {63,1}, {0,17}, {9,10}, {0,7}, {2,2}, {41,1}, {2,1}, {1,0xFF},
    ...
    PROGMEM static const Cell LEVEL_3[] =
    {
        ...
        {0,48}, {0,0xFF},
        {0,48}, {0,0xFF},
        {0,19}, {1,1}, {0,28}, {0,0xFF},
        {0,14}, {4,3}, {0,2}, {1,1}, {0,28}, {0,0xFF},
        {0,19}, {1,1}, {0,2}, {52,1}, {0,25}, {0,0xFF},
        {0,8}, {4,1}, {0,2}, {4,1}, {0,1}, {4,1}, {0,5}, {1,1}, {0,28}, {0,0xFF},
        {0,4}, {4,1}, {0,8}, {4,1}, {0,5}, {1,1}, {0,28}, {0,0xFF},
        {0,2}, {4,1}, {0,45}, {0,0xFF},
        {0,48}, {0,0xFF}
    };
